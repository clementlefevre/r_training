...
The R equivalent an Excel Pivot Table is the group operation.
...
- you can attach as many attachments as you wish, just add a new line with  `Email[["attachments"]]$Add("D:/Users/clementlefevre/data/the_name_of_the_additional_file.xlsx")`
...
Email[["htmlbody"]] =
  ...
  <p>You can find it attached
  </p>"

Email[["attachments"]]$Add("D:/danila_katzenberger/data/DT_top_worst_2_with_customer_support.xlsx")
Email$Send()
...
- Load the "Managers" sheet into a dataframe named `DT_managers`,
