...
library(data.table)
library(openxlsx)
download.file("https://r-training-bookdown.s3.amazonaws.com/data/Financial%2BSample.xlsx", "test.xlsx", mode="wb")
openxlsx::getSheetNames( "test.xlsx")

openxlsx::read.xlsx("https://r-training-bookdown.s3.amazonaws.com/data/Financial%2BSample.xlsx", sheet = "Managers")
