...
<br />
How about the list the **Product** ?
```{r}
...
function myFunction2() {
  var answer = document.getElementById("cars").value;
  if (answer=="saab"){
  document.getElementById("result2").style.color = "red"
  document.getElementById("result2").innerHTML = answer;
  var audio = new Audio('https://freesound.org/data/previews/422/422051_5121236-lq.mp3');
audio.play();
  }
...
<p id="result1">Coucou</p>

 <p id="result2">Coucou</p>
