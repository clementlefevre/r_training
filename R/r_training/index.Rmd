...
```{r pressure-plot, echo=FALSE ,  fig.cap='', fig.align='center', out.width='60%', out.extra='style="background-color: #b10034; padding:10px; display: inline-block;"'}
...
## Why R ?  {-}
Sure, all the cool kids in town use python. But did you know that a R User has 32% more matching chances on Tinder than a python user ? Facts matter.
...
- add two barcharts
- save the output in an other Excel file & sent it via Email.
- call it a day.    
...
When this task occurs once a week, R can automatize it and allows you to spend more time on highly-valuable Teams© meetings.
In this course, we are going to achieve all those steps with R.
At the end of this lesson, you will be able to write a script that complete all those tasks automatically.
Bear with me, it can be challenging at times, but the rewards are worth the pain.
...
>*it is because we don't yet use R that they are difficult.*
