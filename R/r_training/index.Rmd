...
- make basic statistical modeling : regression, clustering.
...
<div id="main_Quizz">
<div id="Quizz_1" ></div>
<div id="Answer_1" class="toggle"><p id="p_Answer_1">.</p>
```{r eval=TRUE}
    max(mtcars$mpg)
```
</div>
...
<div id="Quizz_2" ></div>
<div id="Answer_2" class="toggle"><p id="p_Answer_2">.</p>
```{r eval=FALSE}
...
htmltools::tags$script(src = "quizz9.js")

# load this only in production, in dev mode, the js does not update on hot-reload with bookdown::serve_book() :
...
<input type="text" id="Q1" value="Some text...">

<p id="A1">Coucou</p>


<button onclick="checkAnswer('Q1', 'A1')">Try it</button>
